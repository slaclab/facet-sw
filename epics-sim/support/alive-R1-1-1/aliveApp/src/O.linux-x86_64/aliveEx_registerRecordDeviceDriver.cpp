...
/* Generated from ../O.Common/aliveEx.dbd */
...
int aliveEx_registerRecordDeviceDriver(DBBASE *pbase)
{
...
/* aliveEx_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"aliveEx_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    aliveEx_registerRecordDeviceDriver(*iocshPpdbbase);
}
