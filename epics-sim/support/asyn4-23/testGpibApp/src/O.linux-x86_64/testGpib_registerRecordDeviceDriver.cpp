...
/* Generated from ../O.Common/testGpib.dbd */
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_asynAiFloat64Average, *pvar_dset_devAiTestGpib,
    *pvar_dset_devGpib, *pvar_dset_devAoSoft, *pvar_dset_devAoSoftRaw,
    *pvar_dset_devAoSoftCallback, *pvar_dset_asynAoInt32,
    *pvar_dset_asynAoFloat64, *pvar_dset_devAoTestGpib,
    ...
    *pvar_dset_asynBiUInt32Digital, *pvar_dset_devBiTestGpib,
    ...
    *pvar_dset_asynBoUInt32Digital, *pvar_dset_devBoTestGpib,
    ...
    *pvar_dset_asynLiUInt32Digital, *pvar_dset_devLiTestGpib,
    ...
    *pvar_dset_asynMbbiUInt32Digital, *pvar_dset_devMbbiTestGpib,
    ...
    *pvar_dset_asynSoOctetWrite, *pvar_dset_devSoTestGpib,
...
static const char * const deviceSupportNames[] = {
    ...
    "asynAiFloat64Average", "devAiTestGpib", "devGpib", "devAoSoft",
    "devAoSoftRaw", "devAoSoftCallback", "asynAoInt32", "asynAoFloat64",
    "devAoTestGpib", "asynRecordDevice", "devBiSoft", "devBiSoftRaw",
    "devBiSoftCallback", "devBiDbState", "asynBiInt32",
    "asynBiUInt32Digital", "devBiTestGpib", "devBoSoft", "devBoSoftRaw",
    "devBoSoftCallback", "devBoGeneralTime", "devBoDbState",
    "asynBoInt32", "asynBoUInt32Digital", "devBoTestGpib",
    ...
    "devLiTestGpib", "devLoSoft", "devLoSoftCallback", "asynLoInt32",
    "asynLoUInt32Digital", "devLoTestGpib", "devLsiSoft", "devLsiEnviron",
    "devLsoSoft", "devLsoSoftCallback", "devLsoStdio", "devMbbiSoft",
    "devMbbiSoftRaw", "devMbbiSoftCallback", "asynMbbiInt32",
    "asynMbbiUInt32Digital", "devMbbiTestGpib", "devMbbiDirectSoft",
    ...
    "devMbboTestGpib", "devMbboDirectSoft", "devMbboDirectSoftRaw",
    ...
    "asynSiOctetWriteRead", "asynSiOctetRead", "devSiTestGpib",
    "devSoSoft", "devSoSoftCallback", "devSoStdio", "asynSoOctetWrite",
    "devSoTestGpib", "devSASoft", "devWfSoft", "asynWfOctetCmdResponse",
...
static const dset * const devsl[] = {
    ...
    pvar_dset_devAiTestGpib, pvar_dset_devGpib, pvar_dset_devAoSoft,
    pvar_dset_devAoSoftRaw, pvar_dset_devAoSoftCallback,
    pvar_dset_asynAoInt32, pvar_dset_asynAoFloat64,
    pvar_dset_devAoTestGpib, pvar_dset_asynRecordDevice,
...
int testGpib_registerRecordDeviceDriver(DBBASE *pbase)
{
...
/* testGpib_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"testGpib_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    testGpib_registerRecordDeviceDriver(*iocshPpdbbase);
}
