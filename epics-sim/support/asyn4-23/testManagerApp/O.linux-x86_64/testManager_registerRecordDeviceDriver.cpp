...
/* Generated from ../O.Common/testManager.dbd */
...
static const char * const deviceSupportNames[] = {
    ...
    "asynWfOctetRead", "asynWfOctetWrite", "asynInt8ArrayWfIn",
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_syncInitialize, pvar_func_testManagerDriverRegister,
    pvar_func_testManagerRegister, pvar_func_tsInitialize;
...
int testManager_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    pvar_func_testManagerDriverRegister();
    pvar_func_testManagerRegister();
    pvar_func_tsInitialize();
    iocshRegisterVariable(vardefs);
    return 0;
}

/* testManager_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"testManager_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    testManager_registerRecordDeviceDriver(*iocshPpdbbase);
}
