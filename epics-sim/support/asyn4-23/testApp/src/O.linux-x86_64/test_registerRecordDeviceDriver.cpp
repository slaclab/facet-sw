...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_devTestBlockInp, *pvar_dset_devSoSoft,
...
static const char * const deviceSupportNames[] = {
    ...
    "asynSiOctetWriteRead", "asynSiOctetRead", "devTestBlockInp",
    "devSoSoft", "devSoSoftCallback", "devSoStdio", "asynSoOctetWrite",
    "devSASoft", "devWfSoft", "asynWfOctetCmdResponse",
...
epicsShareExtern reg_func pvar_func_addrChangeDriverRegister,
    pvar_func_arrInitialize, pvar_func_asSub,
    pvar_func_asynExampleRegister, pvar_func_asynInterposeEosRegister,
    ...
    pvar_func_echoDriverRegister, pvar_func_interposeInterfaceRegister,
