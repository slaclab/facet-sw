...
/* Generated from ../O.Common/testEpics.dbd */
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_echoDriverRegister, pvar_func_int32DriverRegister,
    pvar_func_syncInitialize, pvar_func_tsInitialize,
    pvar_func_uint32DigitalDriverRegister;
...
int testEpics_registerRecordDeviceDriver(DBBASE *pbase)
{
...
/* testEpics_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"testEpics_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    testEpics_registerRecordDeviceDriver(*iocshPpdbbase);
}
