...
/* Generated from ../O.Common/testAsynPortDriver.dbd */
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_syncInitialize, pvar_func_testAsynPortDriverRegister,
...
int testAsynPortDriver_registerRecordDeviceDriver(DBBASE *pbase)
{
...
/* testAsynPortDriver_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"testAsynPortDriver_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    testAsynPortDriver_registerRecordDeviceDriver(*iocshPpdbbase);
}
