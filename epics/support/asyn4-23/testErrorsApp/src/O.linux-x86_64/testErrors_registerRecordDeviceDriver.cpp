...
/* Generated from ../O.Common/testErrors.dbd */
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_syncInitialize, pvar_func_testErrorsRegister,
    pvar_func_tsInitialize, pvar_func_register_func_myTimeStampSource;
...
int testErrors_registerRecordDeviceDriver(DBBASE *pbase)
{
...
/* testErrors_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"testErrors_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    testErrors_registerRecordDeviceDriver(*iocshPpdbbase);
}
