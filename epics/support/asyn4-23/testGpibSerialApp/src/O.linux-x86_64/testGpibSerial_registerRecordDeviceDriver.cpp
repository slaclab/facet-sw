...
/* Generated from ../O.Common/testGpibSerial.dbd */
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_devLiTestGpib, *pvar_dset_devLoSoft,
    *pvar_dset_devLoSoftCallback, *pvar_dset_devLoTestGpib,
    ...
    *pvar_dset_devSiEnviron, *pvar_dset_devSiTestGpib,
    *pvar_dset_devSoSoft, *pvar_dset_devSoSoftCallback,
    *pvar_dset_devSoStdio, *pvar_dset_devSoTestGpib, *pvar_dset_devSASoft,
    *pvar_dset_devWfSoft;
...
static const char * const deviceSupportNames[] = {
    ...
    "devAiTestGpib", "devAoSoft", "devAoSoftRaw", "devAoSoftCallback",
    "devAoTestGpib", "devBiSoft", "devBiSoftRaw", "devBiSoftCallback",
    "devBiDbState", "devBiTestGpib", "devBoSoft", "devBoSoftRaw",
    "devBoSoftCallback", "devBoGeneralTime", "devBoDbState",
    "devBoTestGpib", "devCalcoutSoft", "devCalcoutSoftCallback",
    "devEventSoft", "devHistogramSoft", "devLiSoft", "devLiSoftCallback",
    "devLiGeneralTime", "devLiTestGpib", "devLoSoft", "devLoSoftCallback",
    "devLoTestGpib", "devLsiSoft", "devLsiEnviron", "devLsoSoft",
    "devLsoSoftCallback", "devLsoStdio", "devMbbiSoft", "devMbbiSoftRaw",
    "devMbbiSoftCallback", "devMbbiTestGpib", "devMbbiDirectSoft",
    "devMbbiDirectSoftRaw", "devMbbiDirectSoftCallback", "devMbboSoft",
    "devMbboSoftRaw", "devMbboSoftCallback", "devMbboTestGpib",
    ...
    "devSiGeneralTime", "devSiEnviron", "devSiTestGpib", "devSoSoft",
    "devSoSoftCallback", "devSoStdio", "devSoTestGpib", "devSASoft",
    "devWfSoft"
};
...
static const dset * const devsl[] = {
    ...
    pvar_dset_devAiTestGpib, pvar_dset_devAoSoft, pvar_dset_devAoSoftRaw,
    pvar_dset_devAoSoftCallback, pvar_dset_devAoTestGpib,
    pvar_dset_devBiSoft, pvar_dset_devBiSoftRaw,
    pvar_dset_devBiSoftCallback, pvar_dset_devBiDbState,
    pvar_dset_devBiTestGpib, pvar_dset_devBoSoft, pvar_dset_devBoSoftRaw,
    pvar_dset_devBoSoftCallback, pvar_dset_devBoGeneralTime,
    pvar_dset_devBoDbState, pvar_dset_devBoTestGpib,
    ...
    pvar_dset_devLiGeneralTime, pvar_dset_devLiTestGpib,
    pvar_dset_devLoSoft, pvar_dset_devLoSoftCallback,
    pvar_dset_devLoTestGpib, pvar_dset_devLsiSoft,
    ...
    pvar_dset_devMbbiSoftCallback, pvar_dset_devMbbiTestGpib,
    ...
    pvar_dset_devMbboTestGpib, pvar_dset_devMbboDirectSoft,
    ...
    pvar_dset_devSiTestGpib, pvar_dset_devSoSoft,
    pvar_dset_devSoSoftCallback, pvar_dset_devSoStdio,
    pvar_dset_devSoTestGpib, pvar_dset_devSASoft, pvar_dset_devWfSoft
};
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_echoDriverRegister, pvar_func_syncInitialize,
...
int testGpibSerial_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/usr/local/epics/support/asyn4-23";
...
/* testGpibSerial_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"testGpibSerial_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    testGpibSerial_registerRecordDeviceDriver(*iocshPpdbbase);
}
