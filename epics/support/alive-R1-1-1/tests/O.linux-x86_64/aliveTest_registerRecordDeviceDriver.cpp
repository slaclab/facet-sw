...
/* Generated from ../O.Common/aliveTest.dbd */
...
epicsShareExtern rset *pvar_rset_aSubRSET, *pvar_rset_aaiRSET,
    *pvar_rset_aaoRSET, *pvar_rset_aiRSET, *pvar_rset_aliveRSET,
...
epicsShareExtern rso_func pvar_func_aSubRecordSizeOffset,
    ...
    pvar_func_aiRecordSizeOffset, pvar_func_aliveRecordSizeOffset,
...
static const char * const recordTypeNames[] = {
    "aSub", "aai", "aao", "ai", "alive", "ao", "bi", "bo", "calc",
...
int aliveTest_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/usr/local/epics/support/alive-R1-1-1";
...
/* aliveTest_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"aliveTest_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    aliveTest_registerRecordDeviceDriver(*iocshPpdbbase);
}
